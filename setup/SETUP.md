...
Now, you are ready to push some test data into mongod. In the mongo-perf repo, there is a file called `loader.py` which can be used to generate simulated data (by default, it produces 30 days worth of data - current day inclusive).
