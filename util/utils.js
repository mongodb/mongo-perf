...
function initCollections(collections, env, test, multidb, multicoll, shard) {
...
function runTest(
    ...
    if (collections.length == 0) {
        initCollections(collections, env, test, multidb, multicoll, shard);
    }
...
function runTests(
    ...
    cleanupCollections(sharedCollections);
    return testResults;
}
 ...
 * @returns {{}} the results of a run set of tests
 */
function mongoPerfRunTests(threadCounts, multidb, multicoll, seconds, trials, includeFilter, excludeFilter, shard, crudOptions, excludeTestbed, printArgs, shareDataset, mongoeBenchOptions, username, password) {
    testResults = runTests(threadCounts, multidb, multicoll, seconds, trials, includeFilter, excludeFilter, shard, crudOptions, excludeTestbed, printArgs, shareDataset, mongoeBenchOptions, username, password);
    print("@@@RESULTS_START@@@");
